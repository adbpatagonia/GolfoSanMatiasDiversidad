...
m.rich.full_modG <- gam(riqueza ~ s(Depth, k = 20, bs = "tp") +
...
m.rich.full.time_modG <- gam(riqueza ~ s(Depth, k = 20, bs = "tp") +
...
m.rich_modG <- gam(riqueza ~ s(Depth, k = 20, bs = "tp") +
                     s(Year_fac, k = length(levels(mod.dat$Year_fac)), bs = "re"),
                   data = mod.dat,
                   method = "REML", family = "gaussian")
...
m.rich_modGI <- gam(riqueza ~ s(Depth, k = 20, m = 2, bs = "tp") +
...
m.rich_modI <- gam(riqueza ~ s(Depth, Year_fac, k = 20, bs = "fs", m = 2) +
                     s(Year_fac, k = length(levels(mod.dat$Year_fac)), bs = "re"),
                   data = mod.dat,
                   method = "REML", family = "gaussian")
mod <- m.rich_modI
